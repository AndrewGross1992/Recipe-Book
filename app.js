window.onload = function() {
    // 1. Check for incoming recipe data in the URL
    ...
    if (recipeData) {
        try {
            ...
            // Clean the URL to prevent re-saving on refresh
...
function displayRecipes() {
    ...
    if (recipes.length === 0) {
        container.innerHTML = "<p style='text-align:center;'>No recipes saved yet. Open a recipe in Safari and tap your 'Save Recipe' bookmarklet!</p>";
        return;
    }
